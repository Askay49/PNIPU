...
{
	GrEllipseArc(x, y, wn / 2, hn / 2, 2700, 900, GR_ARC_STYLE_OPEN, icolor); //В
	GrEllipseArc(x, y + hn, wn / 2, hn / 2, 2700, 900, GR_ARC_STYLE_OPEN, icolor);
	GrLine(x, y - hn / 2, x, y + hn * 1.5, icolor);

	GrLine(x + wn + 50, y - hn / 2, x + wn * 1.5 + 50, y - hn / 2, icolor);
	GrLine(x + wn + 50, y - hn / 2, x + wn + 50, y + hn, icolor);
	GrLine(x + wn * 1.5 + 50, y - hn / 2, x + wn * 1.5 + 50, y + hn, icolor);
}
