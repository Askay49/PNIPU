...
{
	GrEllipseArc(x + wn, y, wn / 2, hn / 2, 900, 2700, GR_ARC_STYLE_OPEN, icolor);
	GrLine(x + 50, y, x + wn * 2 + 50, y, icolor);
	GrEllipseArc(x + wn + 50, y, wn / 2, hn / 2, 0, 1800, GR_ARC_STYLE_OPEN, icolor);
}
