...
{
	GrLine(x, y+hn/2, x + wn * 2, y+hn/2, icolor);//Д
	GrEllipseArc(x + wn, y+hn/2, wn / 2, hn, 0, 1800, GR_ARC_STYLE_OPEN, icolor);

	GrEllipseArc(x + wn*3, y - hn / 2, wn / 2, hn, 1800, 3600, GR_ARC_STYLE_OPEN, icolor);//И
	GrLine(x + wn*3 + wn / 2, y - hn / 2, x + wn*3 + wn / 2, y + hn / 2, icolor);
}
