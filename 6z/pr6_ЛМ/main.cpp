...
void TName::Draw(int icolor)
{
	...
	GrEllipseArc(x + wn * 2, y + hn / 2, wn / 2, hn, 0, 1800, GR_ARC_STYLE_OPEN, icolor);
	GrEllipseArc(x + wn * 4, y + hn / 2, wn / 2, hn, 0, 1800, GR_ARC_STYLE_OPEN, icolor);
	GrEllipseArc(x + wn * 5, y + hn / 2, wn / 2, hn, 0, 1800, GR_ARC_STYLE_OPEN, icolor);
}
