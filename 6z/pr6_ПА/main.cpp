...
{
	GrLine(x + wn, y - hn / 2, x + wn * 1.5, y - hn / 2, icolor);
	GrLine(x + wn, y - hn / 2, x + wn, y + hn, icolor);
	GrLine(x + wn * 1.5, y - hn / 2, x + wn * 1.5, y + hn, icolor);

	GrEllipseArc(x + 100, y + hn / 2, wn / 2, hn, 0, 1800, GR_ARC_STYLE_OPEN, icolor); // A
	GrLine(x - wn / 2 + 100, y, x + wn / 2 + 100, y, icolor);
}
