...
void TName::Draw(int icolor)
{
	...
	GrEllipseArc(x + wn * 2, y, wn / 2, hn, 0, 1800, GR_ARC_STYLE_OPEN, icolor);
	GrEllipseArc(x + wn * 4, y - hn, wn / 2, hn, 1800, 3600, GR_ARC_STYLE_OPEN, icolor);
	GrLine(x + wn * 4.5, y - hn, x + wn * 4.5, y, icolor);
}
