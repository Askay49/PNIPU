...
{
	GrEllipseArc(x, y, wn / 2, hn, 0, 1800, GR_ARC_STYLE_OPEN, icolor); // A
	GrLine(x - wn / 2, y-hn/2, x + wn / 2, y-hn/2, icolor);

	GrLine(x + 50, y, x + 50 + wn / 2, y-hn, icolor);//X
	GrLine(x + 50 + wn / 2, y, x + 50, y - hn, icolor);
