...
{
	GrEllipseArc(x, y - hn / 4, wn / 2, hn / 4, 900, 2700, GR_ARC_STYLE_OPEN, icolor); // Е
	GrEllipseArc(x, y + hn / 4, wn / 2, hn / 4, 900, 2700, GR_ARC_STYLE_OPEN, icolor);

	GrEllipseArc(x + wn, y, wn / 2, hn / 2, 900, 2700, GR_ARC_STYLE_OPEN, icolor); // С
}
