...
void TName::Draw(int icolor) //функция отрисовки букв
{
	...
	GrEllipseArc(x + wn / 2, y, wn / 2, hn / 2, 900, 2700, GR_ARC_STYLE_OPEN, icolor); // K

	GrLine(x - wn / 2 + 100, y - hn / 2, x + wn / 2 + 100, y - hn / 2, icolor);
	GrLine(x + 100, y - hn / 2, x + 100, y + hn / 2, icolor);
}
